    ...
    async (studentData: Omit<Student, 'id' | 'coordinatorId' | 'createdAt' | 'updatedAt'>) => {
      ...
      const { data, error } = await (supabase as any)
        ...
        .insert({
          ...
          target_career: studentData.targetCareer || null,
          target_university: studentData.targetUniversity || null,
          current_grade: studentData.currentGrade || null,
          learning_style: studentData.learningStyle || null,
          study_methods: studentData.studyMethods?.length ? studentData.studyMethods : null,
          learning_pace: studentData.learningPace || null,
